...
Endereço para acesso ao sistema: http://gve.crt.saude.sp.gov.br
...
1.	Substituir a senha inicial gerada pelo sistema, por outra secreta, pessoal e intransferível;
2.	Não divulgar a minha senha a outras pessoas;
3.	Somente utilizar o meu acesso para os fins designados e para os quais estiver devidamente autorizado, em razão de minhas funções;
4.	Reportar imediatamente à minha chefia ou ao Administrador de Segurança, em caso de violação, acidental ou não, da minha senha, e providenciar a sua substituição.
5.	Solicitar o cancelamento de minha senha quando não for mais de minha responsabilidade a pesquisa de casos já notificados.
6.	Tenho ciência que o descumprimento dos itens acima estarão em desacordo com legislações quanto ao sigilo profissional e suas conseqüências conforme Resolução CFM Nº 1.931, de 17/09/2009 e Código Penal - Artigos nºs 153 e 154.
EOF;
	mail($email, "Cadastro no Consulta de Notificação de Caso", $mail_body, "From: SNAIDS <gve@crt.saude.sp.gov.br>\r\n");
}
